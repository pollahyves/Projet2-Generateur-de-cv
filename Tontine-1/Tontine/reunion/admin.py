...
from .models import AppartenirTontine,Candidat,Cotisation,Cotiser,Election,Fond, Membre,ParticipantReunion,Poste,Pret,Reunion,Tontine,Vote,ListePresence
...
class AdminListeParticipant(admin.ModelAdmin):
    list_display=('id_reunion','id_membre')

#admin.site.register(User)
admin.site.register(ListePresence,AdminListeParticipant)
